...
import { categoryOptions, CreateFormDefaultValue } from '@/lib/types'
import { useCreateApartmentMutation } from '@/redux/features/apartmentApislice'
...
const Page = () => {
    const [createApartment, { isLoading, isSuccess }] = useCreateApartmentMutation()
    const router = useRouter()
    const form = useForm<z.infer<typeof formSchema>>({
        resolver: zodResolver(formSchema),
        defaultValues: CreateFormDefaultValue
    })
    ...
    return (
        <div className='w-full max-w-5xl flex flex-col md:flex-row  max-xl:px-8 my-10 mx-auto'>
            <div className='w-full h-full'>
                <h3 className='text-[20px] font-bold text-primaryColor-900 mb-6'>Create Apartment</h3>
                <Form {...form}>
